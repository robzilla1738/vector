...
mod tests {
    ...
    fn counts_supported_unknown_deferred_and_invalid() {
        let sheet = parse_stylesheet(
            r"
            p { color: red; margin: 1px; animation: fade 1s; frobnicate: 1; }
        ...
        assert_eq!(c.declarations_deferred, 1, "animation");
        ...
        let clean = parse_stylesheet("p { color: red; animation: none }", Origin::Author);
