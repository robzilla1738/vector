...
mod tests {
    ...
    fn counts_supported_unknown_deferred_and_invalid() {
        let sheet = parse_stylesheet(
            r"
            p { color: red; margin: 1px; mix-blend-mode: multiply; frobnicate: 1; }
        ...
        assert_eq!(c.declarations_deferred, 1, "mix-blend-mode");
        ...
        let clean = parse_stylesheet("p { color: red; mix-blend-mode: multiply }", Origin::Author);
