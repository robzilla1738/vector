    ...
    let report = json!({
        ...
        "attribution": {
            ...
            "jetstreamSunspider": {
                ...
                "officialGroup": 12,
                "note": "Official SunSpider group plus Default JS from --jetstream-dir, including zlib .z, AsyncBenchmark, startup/SSR/TypeScript-lib, and late-eval mandreel/pdfjs. Wasm Default tests stay unexecuted. Not a JetStream Next geometric-mean published score."
            },
            "motionmark13": {
                "officialNames": 8,
