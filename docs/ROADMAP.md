...
| H1-D3 | Public corpus ≥ 500 real URLs | D | ☑ | `docs/engine/evidence/corpus-500-latest.json` (live fetch 488/500, 12 bot-wall/timeout; engine `capability_unsupported` 0/488 opened bodies; compact observe p50 1.56 ms / p95 3.15 ms; open→observe p50 13.9 ms / p95 29.3 ms / max 78.8 ms on `117` at 256 KB parse cap + unclosed-style trim; snapshot tokens p95 2999 at `maxTokens: 3000`; `ve_html::HTML_BYTES_CAP`; not a D5 deletion license) |
