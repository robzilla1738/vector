...
| H1-D3 | Public corpus ≥ 500 real URLs | D | ☑ | `docs/engine/evidence/corpus-500-latest.json` (live fetch 488/500, 12 bot-wall/timeout; engine `capability_unsupported` 0/60 opened bodies; compact observe p50 1.67 ms / p95 7.45 ms; open→observe p50 14.7 ms / p95 102 ms / max 1129 ms; snapshot tokens p95 2999 at `maxTokens: 3000`; not a D5 deletion license) |
