...
| H1-D3 | Public corpus ≥ 500 real URLs | D | ☑ | `docs/engine/evidence/corpus-500-latest.json` (live fetch 488/500, 12 bot-wall/timeout; engine `capability_unsupported` 0/60 opened bodies; compact observe p50 1.55 ms / p95 2.96 ms; open→observe p50 14.0 ms / p95 28.2 ms / max 47.6 ms on `136` at 256 KB parse cap; snapshot tokens p95 2998 at `maxTokens: 3000`; `ve_html::HTML_BYTES_CAP`; not a D5 deletion license) |
