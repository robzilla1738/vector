...
| §6 this-host software present | 0 after first paint | `docs/perf/section-6-this-host.json` | x86_64 Linux; not Apple silicon; IME/wheel/full-repaint p50 ≈ 500 ms (software chrome raster) |
